//base on other's exp to write my understanding
...
//raw_vmlinux_base is calculate by "like you find an address 'cat /tmp/kallsyms | grep commit_cred', and use the address to decrece the offset of commit_cred of the linux kernel version "
//and the calculation is under the nokalsr like "print(hex(0xffffffff8109c8e0 - 0x9c8e0))", the 0x9c8e0 is the offset of the version
